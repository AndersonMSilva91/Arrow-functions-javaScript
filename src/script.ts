...
const weight = Number(prompt('Type your weight: '));
const height = Number(prompt('Type youur height: '));
...
console.log(`Your Body Mass Index is: ${bmiresult}.`) // perguntar como arredonda o pesso do corpitcho